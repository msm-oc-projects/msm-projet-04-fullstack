...
describe('DetailComponent integration', () => {
  ...
  it('displays Delete only to an admin', () => {
    ...
    expect(adminFixture.nativeElement.textContent).toContain('Delete');
    expect(adminFixture.nativeElement.textContent).not.toContain('Participate');
